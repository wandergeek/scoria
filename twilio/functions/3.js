...
exports.handler = async (context, event, callback) => {
  ...
  if(who.search(regex) != -1) { //found match
    ...
    response = "Oh? That's interesting. Me, I have ten thousand siblings. All born in the same instant. And indeed, Mother branded us with names as oxygen brushed our new skin."
  }
